  ...
  if (step === 'done') {
    return (
      <div className="flex flex-col items-center py-12 text-center">
        ...
        <button
          onClick={() => { setStep('form'); setCurrentPw(''); setNewPw(''); setConfirmPw(''); setOtp(['','','','','','']); }}
          className="mt-5 text-sm text-[#1E3A8A] hover:underline"
        >
          Change again
        </button>
      </div>
    ...
    <div className="max-w-sm space-y-4">
      ...
      <div>
        ...
        {confirmPw && confirmPw !== newPw && (
          <p className="ff-error">Passwords do not match</p>
        )}
      </div>
      <div className="pt-1">
        <button
