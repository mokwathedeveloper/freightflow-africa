...
export function DashboardSidebar({ role, items }: Props) {
  ...
  return (
    ...
    >
      ...
      {/* ── User profile + logout ─────────────────────────────── */}
      <div className="px-3 pb-3 pt-2 shrink-0" style={{ borderTop: '1px solid rgba(255,255,255,0.1)' }}>
        {/* User card */}
        <div className="flex items-center gap-3 px-3 py-2.5 mb-1">
          ...
          <div className="min-w-0">
            ...
            <p className="text-xs capitalize leading-tight truncate" style={{ color: 'rgba(255,255,255,0.55)' }}>
              {role}
            </p>
          </div>
        </div>
